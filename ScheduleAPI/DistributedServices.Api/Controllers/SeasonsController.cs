...
namespace DistributedServices.Api.Controllers
{
    public class SeasonsController : ApiController
    {
        ...
        {
            _repository = IoCFactory.Resolve<ISeasonRepository>();
        }
        ...
        public HttpResponseMessage Post([FromBody]Season item)
        {
            if (item == null)
        ...
        public HttpResponseMessage Put([FromUri]int id, [FromBody]Season item)
        {
            if (item == null)
                return Request.CreateResponse(HttpStatusCode.OK, new Season());
